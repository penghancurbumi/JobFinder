<template>
  ...
  <div v-if="!isPreview">
    ...
    <div v-if="currentId === 'personal_info'" class="flex flex-col gap-[20px]">
      ...
      <div class="flex flex-col gap-sm mb-lg">
        <label class="flex items-center gap-sm cursor-pointer w-max">
          ...
          <span class="text-[14px] text-on-dark-mute ">Gunakan Foto Profil pada Sidebar</span>
        </label>
    ...
    <div v-else-if="currentId === 'exec_summary'" class="flex flex-col gap-[20px]">
      ...
      <div class="flex flex-col">
        <label class="mb-[8px]  text-on-dark-mute">Executive Summary <span class="text-accent-danger">*</span>
        ...
        <div v-if="suggestions.exec_summary" class="bg-surface-deep px-[16px] py-[12px] rounded-md text-[13px] text-on-dark-mute mt-[8px]"><span class=" text-white">Saran AI:</span> {{ suggestions.exec_summary }}</div>
      </div>
    </div>
    ...
    <div v-else-if="currentId === 'competencies'" class="flex flex-col gap-[20px]">
      ...
      <div>
        <label class="mb-[12px]  text-on-dark-mute block">Kompetensi Inti <span class="text-accent-danger">*</span></label>
      ...
      <div class="border border-hairline-dark rounded-[16px] p-[20px]">
        ...
        <div class="flex flex-col gap-[16px]">
          <div class="grid grid-cols-1 sm:grid-cols-2 gap-[12px]">
            <div class="flex flex-col col-span-2 sm:col-span-1"><label class="mb-[8px]  text-on-dark-mute">Nama Perusahaan <span class="text-accent-danger">*</span></label>
            ...
            <div class="flex flex-col col-span-2 sm:col-span-1"><label class="mb-[8px]  text-on-dark-mute">Lokasi</label>
          ...
          <div class="border-t border-hairline-dark pt-[16px]">
            <h5 class="text-[14px]  text-on-dark mb-[4px]">Tanggung Jawab & Pencapaian <span class="text-accent-danger">*</span></h5>
    ...
    <div v-else-if="currentId === 'education'">
      <div class="flex flex-col gap-[16px]">
        ...
        <div class="flex flex-col"><label class="mb-[8px]  text-on-dark-mute">Institusi <span class="text-accent-danger">*</span></label>
    ...
    <div v-else-if="currentId === 'achievements'" class="flex flex-col gap-[20px]">
      ...
      <div>
        <label class="mb-[12px]  text-on-dark-mute block">Pencapaian Utama <span class="text-accent-danger">*</span>
        ...
        <div v-if="suggestions.achievements" class="bg-surface-deep px-[16px] py-[12px] rounded-md text-[13px] text-on-dark-mute mt-[8px]"><span class=" text-white">Saran AI:</span> {{ suggestions.achievements }}</div>
  ...
  <div v-else class="bg-white text-black leading-[1.5] flex min-h-[1000px]" :style="{ fontFamily: templateFont }">
    ...
    <div class="w-[200px] shrink-0 bg-[#1a1a2e] text-white p-[24px] flex flex-col gap-[20px]">
      ...
      <!-- Name on Sidebar -->
      <div>
        <div class="text-[16px] uppercase tracking-[1px] leading-[1.2] text-white">{{ formData.full_name || '[Nama Anda]' }}</div>
        <div v-if="formData.designation" class="text-[11px] text-blue-300 mt-[4px] font-medium tracking-[0.5px]">{{ formData.designation }}</div>
      </div>

      <!-- Contact -->
      <div>
        <div class="text-[9px] uppercase tracking-[2px] text-white/50 mb-[8px]">Kontak</div>
      ...
      <div v-if="filteredCompetencies.length > 0">
        <div class="text-[9px] uppercase tracking-[2px] text-white/50 mb-[10px]">Kompetensi Inti</div>
        <div class="flex flex-col gap-[6px]">
      ...
      <div v-if="educations.length > 0">
        <div class="text-[9px] uppercase tracking-[2px] text-white/50 mb-[10px]">Pendidikan</div>
        <div v-for="(edu, i) in educations" :key="i" class="mb-[10px]">
          <div class="text-[11px] text-white">{{ edu.degree }}</div>
    ...
    <div class="flex-1 p-[32px]">
      ...
      <div v-if="formData.exec_summary" class="mb-[24px]">
        ...
        <h2 class="text-[10px] uppercase tracking-[2px] text-[#1a1a2e] mb-[8px]">Executive Summary</h2>
      ...
      <div v-if="workExperiences.length > 0" class="mb-[24px]">
        ...
        <h2 class="text-[10px] uppercase tracking-[2px] text-[#1a1a2e] mb-[12px]">Pengalaman Profesional</h2>
        <div v-for="(work, i) in workExperiences" :key="i" class="mb-[16px]">
          <div class="flex justify-between items-start mb-[2px]">
            <div>
              <div class="text-[13px] text-[#1a1a2e]">{{ work.position }}</div>
      ...
      <div v-if="filteredAchievements.length > 0" class="mb-[24px]">
        <div class="h-[2px] bg-gray-200 mb-[12px]"></div>
        <h2 class="text-[10px] uppercase tracking-[2px] text-[#1a1a2e] mb-[10px]">Pencapaian Utama</h2>
        <div class="grid grid-cols-1 gap-[6px]">
          <div v-for="(ach, i) in filteredAchievements" :key="i" class="flex gap-[8px] items-start">
            <span class="text-[#1a1a2e] text-[14px] shrink-0 mt-[-1px]">★</span>
