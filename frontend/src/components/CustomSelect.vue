<template>
  <div class="relative" ref="selectContainer">
    ...
    <button 
      ...
      class="w-full bg-transparent border border-hairline-dark rounded-sm h-[50px] px-[12px] text-on-dark focus:border-white focus:outline-none flex items-center justify-between text-xs md:text-sm cursor-pointer transition-colors"
